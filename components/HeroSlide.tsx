...
const HeroSlide = () => {
  return (
      <div className="mx-auto max-w-7xl  lg:px-8">
        <div className="relative isolate overflow-hidden bg-red-800 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          <svg
          ...
          >
            ...
            <defs>
              <radialGradient id="759c1415-0410-454c-8f7c-9a820de03641">
                <stop stopColor="#3b82f6" /> {/* Blueish */}
                <stop offset="0.5" stopColor="#fbbf24" /> {/* Yellow */}
